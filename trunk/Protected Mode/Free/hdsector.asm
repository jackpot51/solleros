...
jmp start ;;fuck trying to set up FAT for now
;FATDRIVETABLE:
...
diskaddresspacket:
len:	db 0x16	;;size of packet
	db 0
	dw 100	;;blocks to read
addr:	dw 0x0	;;address 0
segm:	dw 0x2000	;;segment 2222
lbaad:	dd 1	;;lba address
	dd 0				

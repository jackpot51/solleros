...
qemu  -boot c -std-vga -soundhw sb16 -hda SollerOS-linux.bin -usb -net nic,model=rtl8139,vlan=1,macaddr=52:54:00:12:34:56 -net user,vlan=1 -serial stdio -d int,pcall

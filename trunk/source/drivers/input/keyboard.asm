...
scancode:
	;key, KEY, alt key, ALT KEY, ctrl key, CTRL KEY
	db 0,0,0,0,0,0				;0h
	db 0,0,0,0,0,0				;1h
	db '1','!',0xAD,0x13,0,0	;2h
	db '2','@',0xFD,0xFB,0,0	;3h
	db '3','#',0,0,0,0			;4h
	db '4','$',0x9B,0x9C,0,0	;5h
	db '5','%',0xEE,0,0,0		;6h
	db '6','^',0xAC,0xFC,0,0	;7h
	db '7','&',0xAB,0,0,0		;8h
	db '8','*',0xEC,0x7,0,0		;9h
	db '9','(',0,0,0,0			;0Ah
	db '0',')',0,0,0,0			;0Bh
